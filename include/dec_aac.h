...
#define AAD_DSF_IEEE32          6
#define AAD_DSF_IEEE64          7
 /** @} */
...
static const char * audio_object_types[] =
{
    "Null",
    "AAC Main",
    "AAC LC",
...
/**
    ...
    * @return  point to a @ref bufstream interface
    **/
bufstream_tt* MC_EXPORT_API open_AACin_Audio_stream_ex(void *(MC_EXPORT_API *get_rc)(const char* name), long reserved1, long reserved2);
