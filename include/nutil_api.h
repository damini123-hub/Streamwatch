...
public:
    ...
    **/
    virtual MainConcept::NetworkStreaming::MCNETRESULT Open( int8_t *pFilePath, int8_t *pIndexPath = NULL ) = 0;

	/**
    * @brief Open cache file with unicode path
    *
    * @param[in]	pFilePath		Path to cache file
    * @param[in]	pIndexPath		Path to saved cache index table file
    *
    * @return		MCNetResultOK on success or error code on failure
    **/
	virtual MainConcept::NetworkStreaming::MCNETRESULT Open( wchar_t *pFilePath, wchar_t *pIndexPath = NULL ) = 0;
	...
	* @return		MCNetResultOK on success or error code on failure
	**/
	virtual MainConcept::NetworkStreaming::MCNETRESULT SaveIndex( int8_t *pIndexPath ) = 0;

	/**
	* @brief Save cache file index with unicode path
	*
	* @param[in]	pIndexPath		Path to cache index table file
	*
	* @return		MCNetResultOK on success or error code on failure
	**/
	virtual MainConcept::NetworkStreaming::MCNETRESULT SaveIndex( wchar_t *pIndexPath ) = 0;
	...
	* @return		MCNetResultOK on success or error code on failure
	**/
	virtual MainConcept::NetworkStreaming::MCNETRESULT Write( const int8_t *pBuffer, int32_t iBufferSize, int64_t i64Position = -1 ) = 0;
	...
	* @return		MCNetResultOK on success or error code on failure
	**/
	virtual MainConcept::NetworkStreaming::MCNETRESULT Read( int8_t *pBuffer, int32_t iBufferSize, int64_t i64Position = -1, int32_t *pReadBytes = NULL ) = 0;
...
extern "C" {
    ...
    **/
	MainConcept::NetworkStreaming::ISharedSocketInfo * MC_NET_UTILS_API CreateSharedSocketInfo( void *(MC_EXPORT_API *get_rc)(const char*), const int8_t *pData = NULL, uint32_t uiSize = 0 );
    ...
    **/
	MainConcept::NetworkStreaming::IDataSource * MC_NET_UTILS_API CreateAsyncFileReader( void *(MC_EXPORT_API *get_rc)(const char*), const wchar_t *pURI, uint32_t uiCacheSize );
