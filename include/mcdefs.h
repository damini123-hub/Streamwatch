...
#define MPEG_LAST_MPEG_TYPE        51      ///< last MPEG type
/** @} */
...
#define MPEG4_AAC_AUDIO_PSP    16      ///<    MPEG-4 AAC with Sony Play Station Portable resctrictions
...
#define OPT_EXT_PARAM_FORCE_IDR         (0x00800000L)   /**< @brief For a current frame forces it to be an IDR (enc_avc only) respecting chapter list and minimal IDR interval @hideinitializer */
...
#define OPT_INSERT_KEY_FRAME      (0x00001000L)   /**<@brief @brief Encode current frame as I-frame */
...
enum parse_aux
{
  ...
  PARSE_OPTIONS        = 0x00010002, /**<  set decoder options */
...
//  SEARCH_PIC_HDR       = 0x00000100, //unused
  ...
  DEC_AVC_RESERVED_00010085 = 0x00010085,
  ...
  DEC_AVC_RESERVED_0001008a = 0x0001008a,
  ...
  HWACC_GET_HW_CAPS		= 0x00200000, /**<    */
  HWACC_SET_ACC_MODE    = 0x00200001, /**<    */
...
/** \addtogroup video_dec_mpeg_group Video decoder structures and defines
 \{
*/
////////////////////////////////
...
<tr> <td><b> VC-1 </b></td>	<td> T> Number units in tick. </td> </tr>
</table>
*/
  int units;
};
...
/**
 one of the following FourCC values:

 <table border>
 <tr> <td> value </td> 				<td> meaning </td>  </tr>
<tr> <td> FOURCC_AYUV </td> 	<td>  AYUV, packed YUV, 4:4:4, 32 bpp  </td>  </tr>
<tr> <td> FOURCC_VUYA </td> 	<td> VUYA, packed YUV, 4:4:4, 32 bpp  </td>  </tr>
<tr> <td> FOURCC_UYVY </td> 	<td> UYVY, packed YUV, 4:2:2, 16 bpp  </td>  </tr>
<tr> <td> FOURCC_YUYV, </td> 	<td> YUYV, packed YUV, 4:2:2, 16 bpp  </td>  </tr>
<tr> <td> FOURCC_YUY2 </td> 	<td> YUYV, packed YUV, 4:2:2, 16 bpp  </td>  </tr>
<tr> <td> FOURCC_YVYU </td> 	<td> YVYU, packed YUV, 4:2:2, 16 bpp  </td>  </tr>
<tr> <td> FOURCC_V210 </td> 	<td> v210, packed YUV, 4:2:2, 10 bits per component, 20 bpp  </td>  </tr>
<tr> <td> FOURCC_Y41P </td> 	<td> Y41P, packed YUV, 4:1:1, 12 bpp  </td>  </tr>
<tr> <td> FOURCC_CLJR </td> 	<td> CLJR, packed YUV, 4:1:1, 8 bpp  </td>  </tr>
<tr> <td> FOURCC_YV24 </td> 	<td> YV24, planar YUV, 4:4:4, planes order: Y->V->U, 24 bpp  </td>  </tr>
<tr> <td> FOURCC_YV16 </td> 	<td> YV16, planar YUV, 4:2:2, planes order: Y->V->U, 16 bpp  </td>  </tr>
<tr> <td> FOURCC_YV12 </td> 	<td> YV12, planar YUV, 4:2:0, planes order: Y->V->U, 12 bpp  </td>  </tr>
<tr> <td> FOURCC_YVU9 </td> 	<td> YVU9, planar YUV, planes order Y->V->U, 9 bpp  </td>  </tr>
<tr> <td> FOURCC_NV12 </td> 	<td> NV12, planar YUV, 4:2:0, planes order Y->UV, UV interleaved, 12 bpp  </td>  </tr>
<tr> <td> FOURCC_NV21 </td> 	<td> NV21, planar YUV, 4:2:0, planes order Y->UV, UV interleaved, 12 bpp  </td>  </tr>
<tr> <td> FOURCC_NV24 </td> 	<td> NV24, planar YUV, 4:4:4, planes order Y->UV, UV interleaved, 24 bpp  </td>  </tr>
<tr> <td> FOURCC_Y410 </td> 	<td> Y410, packed YUV, 4:4:4, 10 bits per component, 2 bits of alpha, 48 bpp  </td>  </tr>
<tr> <td> FOURCC_Y416 </td> 	<td> Y416, packed YUV, 4:4:4, 16 bits per component, 64 bpp  </td>  </tr>
<tr> <td> FOURCC_Y210 </td> 	<td> Y210, packed YUV, 4:2:2, 16 bits per component but only low 10 bits are significant, 32 bpp  </td>  </tr>
<tr> <td> FOURCC_Y216 </td> 	<td> Y216, packed YUV, 4:2:2, 16 bits per component, 32 bpp  </td>  </tr>
<tr> <td> FOURCC_Y211 </td> 	<td> Y211, packed YUV, 2:1:1, 8 bits per component, 8 bpp  </td>  </tr>
<tr> <td> FOURCC_P210 </td> 	<td> P210, planar YUV, 4:2:2, 16 bits per component but only low 10 bits are significant, 32 bpp  </td>  </tr>
<tr> <td> FOURCC_P216 </td> 	<td> P216, planar YUV, 4:2:2, 16 bits per component, 32 bpp  </td>  </tr>
<tr> <td> FOURCC_P010 </td> 	<td> P010, planar YUV, 4:2:0, 16 bits per component but only low 10 bits are significant, 24 bpp  </td>  </tr>
<tr> <td> FOURCC_P016 </td> 	<td> P016, planar YUV, 4:2:0, 16 bits per component, 24 bpp  </td>  </tr>
<tr> <td> FOURCC_W409 </td> 	<td> Planar YUV, 4:4:4, 16 bits per component but only low 9 bits are significant, 48 bpp  </td>  </tr>
<tr> <td> FOURCC_W410 </td> 	<td> Planar YUV, 4:4:4, 16 bits per component but only low 10 bits are significant, 48 bpp  </td>  </tr>
<tr> <td> FOURCC_W411 </td> 	<td> Planar YUV, 4:4:4, 16 bits per component but only low 11 bits are significant, 48 bpp  </td>  </tr>
<tr> <td> FOURCC_W412 </td> 	<td> Planar YUV, 4:4:4, 16 bits per component but only low 12 bits are significant, 48 bpp  </td>  </tr>
<tr> <td> FOURCC_W416 </td> 	<td> Planar YUV, 4:4:4, 16 bits per component, 48 bpp  </td>  </tr>
<tr> <td> FOURCC_W209 </td> 	<td> Planar YUV, 4:2:2, 16 bits per component but only low 9 bits are significant, 32 bpp  </td>  </tr>
<tr> <td> FOURCC_W210 </td> 	<td> Planar YUV, 4:2:2, 16 bits per component but only low 10 bits are significant, 32 bpp  </td>  </tr>
<tr> <td> FOURCC_W211 </td> 	<td> Planar YUV, 4:2:2, 16 bits per component but only low 11 bits are significant, 32 bpp  </td>  </tr>
<tr> <td> FOURCC_W212 </td> 	<td> Planar YUV, 4:2:2, 16 bits per component but only low 12 bits are significant, 32 bpp  </td>  </tr>
<tr> <td> FOURCC_W216 </td> 	<td> Planar YUV, 4:2:2, 16 bits per component, 32 bpp  </td>  </tr>
<tr> <td> FOURCC_W009 </td> 	<td> Planar YUV, 4:2:0, 16 bits per component but only low 9 bits are significant, 24 bpp  </td>  </tr>
<tr> <td> FOURCC_W010 </td> 	<td> Planar YUV, 4:2:0, 16 bits per component but only low 10 bits are significant, 24 bpp  </td>  </tr>
<tr> <td> FOURCC_W011 </td> 	<td> Planar YUV, 4:2:0, 16 bits per component but only low 11 bits are significant, 24 bpp  </td>  </tr>
<tr> <td> FOURCC_W012 </td> 	<td> Planar YUV, 4:2:0, 16 bits per component but only low 12 bits are significant, 24 bpp  </td>  </tr>
<tr> <td> FOURCC_W016 </td> 	<td> Planar YUV, 4:2:0, 16 bits per component, 24 bpp  </td>  </tr>
<tr> <td> FOURCC_BGR4 </td> 	<td> RGB32, packed RGB, 32 bpp  </td>  </tr>
<tr> <td> FOURCC_BGRA </td> 	<td> ARGB32, packed RGB with alpha channel, 32 bpp  </td>  </tr>
<tr> <td> FOURCC_ARGB </td> 	<td> BGRA32, Packed RGB with alpha channel, 32 bpp  </td>  </tr>
<tr> <td> FOURCC_R555 </td> 	<td> RGB555, packed RGB, 16 bpp  </td>  </tr>
<tr> <td> FOURCC_R565 </td> 	<td> RGB565, packed RGB, 16 bpp  </td>  </tr>
<tr> <td> FOURCC_BGR3 </td> 	<td> RGB24, packed RGB, 24 bpp  </td>  </tr>
<tr> <td> FOURCC_VUYA32F </td> 	<td> like VUYA but 32 bits per component (single float), 128 bpp  </td>  </tr>
<tr> <td> FOURCC_BGRA32F </td> 	<td> like BGRA but 32 bits per component (single float), 128 bpp </td>  </tr>

 <tr> <td> 0</td> 	<td>Getting access to internal decoded frame buffer without color conversion. The decoder fills passed frame_tt data structure: sets pointers to image planes, picture width, height, stride and specifies chroma format by setting 				the four_cc data field to FOURCC_YV12 (if sequence has 4:2:0 chroma sampling) or to FOURCC_YV16 (if sequence has 4:2:2 chroma sampling).</td>  </tr>
</table>
*/
  uint32_t       four_cc;
  ...
  int32_t       cc_pix_range;       /**<@brief Pixel range conversion
                                                     ...
                                                     <tr>
                                                         ...
                                                         <td>No conversion. Depends from VUI-video_full_range_flag.
                                                             <br>If VUI-video_full_range_flag equal to zero then doesn't allow to go beyond short range when use color resampling (for example when use conversion from 4:2:0 to 4:2:2 format)</br>
                                                             <br>default value </br>
                                                         </td>
                                                     </tr>
                                                     <tr>
                                                         ...
                                                         <td>Conversion to short range [16..235]. Depends from VUI-video_full_range_flag.
                                                             <br>If VUI-video_full_range_flag equal to 1 this indicates what input stream is full range and encoded stream should be convert to short range;</br>
                                                             <br>If VUI-video_full_range_flag equal to 0 then doesn't allow to go beyond short range when use color resampling (for example when use conversion from 4:2:0 to 4:2:2 format);</br>
                                                         </td>
                                                     </tr>
                                                     <tr>
                                                         <td>2</td>
                                                         <td>Conversion to full range [0..255]. Depends from VUI-video_full_range_flag.
                                                         <br>If VUI-video_full_range_flag equal to 1 then will keep full range.</br>
                                                         <br>If VUI-video_full_range_flag equal to 0 this indicates what input stream is short range and encoded stream should be convert to full range.</br>
                                                         </td>
                                                     </tr>
                                                     <tr>
                                                         <td>3</td>
