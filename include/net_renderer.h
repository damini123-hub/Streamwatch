    ...
    namespace NetworkStreaming {
        ...
        **/
        typedef struct _tagRtspRedirectParams {
            ...
            const int8_t*   pServerAddr;                            /**< new server address */
        ...
        **/
        typedef struct _tagSenderConnectionInitParams {
            ...
            int8_t*             aNIC;                               /**< Local network interface */
            int8_t*             aRemoteName;                        /**< Remote address */
        ...
        **/
        ...
        public:
            ...
            * @return                       Return @ref NETRENDERERERRORS
            **/
            virtual NETRENDERERERRORS OnData( int8_t *pData, uint32_t uiDataLen, uint32_t uiID, void* pUserDefinedParams = NULL, int32_t iUserParamsSize = 0 ) = 0;
        ...
        **/
        ...
        public:
            ...
            * @return                 Return @ref NETRENDERERERRORS
            **/
            virtual NETRENDERERERRORS PrepareAnnounce( const ISdpDecoder *pSdpDocument, const int8_t *aRemoteName = NULL, uint32_t aTTL = 255 ) = 0;
        ...
        **/
        ...
        public:
            ...
            **/
            virtual RTSPSERVERERRORS Init( int32_t aPort, const int8_t *aNIC, const wchar_t *pMediaFolder = L".", bool bIsForceES = false ) = 0;
        ...
        **/
        ...
        public:
            ...
            * @return                   Return @ref RTSPSERVERERRORS
            **/
            virtual RTSPSERVERERRORS OnDescribe( const wchar_t *pMediaFullPath, bool bIsForceES, const ISdpDecoder **pSdpDocument ) = 0;
            ...
            * @return                Return @ref RTSPSERVERERRORS
            **/
            virtual RTSPSERVERERRORS OnGetParameter( const int8_t* pParamName, int32_t iParamLen, int8_t* pValue, int32_t* iValueLen ) = 0;
            ...
            * @return                       Return @ref RTSPSERVERERRORS
            **/
            virtual RTSPSERVERERRORS OnCommand( const int8_t* pCommandName, const int8_t* pControlUri, int32_t iMaxHeaderLen, int8_t* pAdditionalHeader ) = 0;
        };
        ...
        **/
        ...
        public:
            ...
            * @return                    None
            **/
            virtual void OnNewClientConnection( int64_t ID, const int8_t *pClientsAddress ) = 0;
            ...
            * @return                      None
            **/
            virtual void OnData( int64_t ID, const wchar_t *pBuff, int32_t iLen, bool bIsServerResponse ) = 0;
        };
