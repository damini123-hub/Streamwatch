...
struct mp2mux_stream_set_struct
{
    mc_stream_format_t format_struct; //!< mc_mediatype and format structure: video, audio or user-defined private
                                      ...
                                      The format_struct has a major type (PES / ES) and mediatype (AAC, H.264,
    ...
    int32_t flags;                    //!< flags, one or more of the STREAM_FLAGS_ defines
                                      /*!< @details The best way to specify the mediatype is to use the format_struct.
    ...
    uint8_t enhanced_parsing_flag;    //!< set to 1 to enable parsing of input stream data when new data has a valid timestamp
...
//! @param[in]     muxer      pointer to a MPEG Muxer object
//! @param[in]     ext_set    pointer to a \ref mp2mux_ext_set_struct structure, can be NULL
//! @param[in]     output     pointer to an output filename or bufstream for the output muxed data (BS version)
//! @return    MUX_OK if successful \n
//!    MUX_ERR if unsuccessful
//!@{
...
//!
//! @param[in]     muxer      pointer to a MPEG Muxer object
//! @param[in]     set        pointer to a \set mp2mux_stream_set_struct structure
//! @param[in] input     input      pointer to a filename for the input data
