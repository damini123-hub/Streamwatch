    ...
    namespace NetworkStreaming {
        ...
        **/
        typedef enum _tagMCNetEngineStatus {
            ...
            MCNetEngineStatusPaused     = 5,                        /**< Engine is paused */
        ...
        **/
		...
		public:
            ...
            **/
			virtual const wchar_t * GetStreamName() const = 0;
            ...
            **/
			virtual const int8_t * GetMimeType( bool bForceMimeTypeDetectionByExt = false ) = 0;
		};
        ...
        public:
			...
			**/
			virtual const int8_t *EnumAttributes( uint32_t uiIndex, const int8_t **pName ) const = 0;
			...
			**/
			virtual const int8_t *GetAttributeValue( const int8_t *pName ) const = 0;
        };
        ...
        public:
            ...
            virtual const int8_t *GetURI(  ) const = 0;
        ...
        **/
        ...
        public:
            ...
            **/
            virtual const int8_t * Serialize(uint32_t * uiSize) const = 0;
        };
