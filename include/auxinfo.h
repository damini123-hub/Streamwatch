...
struct v_au_struct
{
  ...
  uint16_t type;                /**< One of the *_TYPE codes   */
...
struct sample_struct
{
	...
	uint8_t bSysClockValid;
    int64_t sysClock;		/**< 27 MHz clocks, for PCR/SCR or other system timestamp */
...
struct dd_stream_info
{
  ...
  // align structure to 64 bytes:
  uint8_t reserved[64 - 10 * sizeof(int32_t)];
};
/** @} */
...
{
  uint32_t pict_type;           /**< One of the picture type codes */
